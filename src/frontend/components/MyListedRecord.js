...
export default function MyListedRecords({ collegeplatform, nft, account }) {
  console.log(account)
      ...
      console.log("inside loadListedRecords")
        ...
        for (let indx = 1; indx <= recordCount; indx++) {
          console.log("indx: ",indx)
            ...
            //**************************** 
            if ("0x976ea74026e726554db657fa54763abd0c3a0aa9" === account) {
    ...
    useEffect(() => {
      ...
      //for home component loading page
      if (loading) return (
